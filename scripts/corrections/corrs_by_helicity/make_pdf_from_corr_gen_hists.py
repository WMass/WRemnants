...
THEORY_PREDS = {
    ...
    "scetlib_dyturbo_LatticeNP_MSHT20mbrange_N3p0LL_N2LO_pdfvars": {"pdf": "msht20mbrange"},
    "scetlib_dyturbo_LatticeNP_MSHT20mcrange_N3p0LL_N2LO_pdfvars": {"pdf": "msht20mcrange"},
}
