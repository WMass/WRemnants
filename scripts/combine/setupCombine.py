...
def make_parser(parser=None):
    ...
    parser.add_argument("-n", "--baseName", nargs="+", type=str, help="Histogram name in the file (e.g., 'nominal')", default="nominal")
    ...
    parser.add_argument("--lumiScale", type=float, default=1.0, nargs = "*", help="Rescale equivalent luminosity by this value (e.g. 10 means ten times more data and MC)")
...
if __name__ == "__main__":
    ...
    if args.hdf5:
        ...
        lumiScales = args.lumiScale
        for i, ifile in enumerate(args.inputFile):
            fitvar = args.fitvar[i].split("-")
            ibaseName = baseNames[i]
            ilumiScale = lumiScales[i]
